...
from models import ImageEncoder, ProjectionHead, BERTxSAGE, TextEncoder, ImageEncoderTimm, sentencesTransformer
...
class PrescriptionPill(nn.Module):
    ...
    def get_text_features(self, data):
        x = self.text_encoder(data)
